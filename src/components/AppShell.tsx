    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .sidebar{grid-area:sidebar;position:sticky;top:var(--topbar-h);height:calc(100dvh - var(--topbar-h));overflow-y:auto;overflow-x:hidden;padding:28px 12px 60px;border-right:1px solid var(--border);background:rgba(6,13,8,0.6);display:flex;flex-direction:column;gap:4px;}
...
.tag-select{padding:6px 10px;border-radius:8px;background:rgba(255,255,255,0.04);border:1px solid var(--border);color:var(--text-2);font-size:11px;font-family:'Sora',sans-serif;outline:none;cursor:pointer;colorScheme:dark;}
        ...
        .sidebar{position:fixed!important;top:var(--topbar-h);left:0;width:var(--sidebar-w);height:calc(100dvh - var(--topbar-h));z-index:400;transform:translateX(-100%);...}
