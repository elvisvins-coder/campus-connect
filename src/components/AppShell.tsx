    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .sidebar{grid-area:sidebar;position:sticky;top:var(--topbar-h);height:calc(100dvh - var(--topbar-h));overflow-y:auto;overflow-x:hidden;padding:28px 12px 32px;border-right:1px solid var(--border);background:rgba(6,13,8,0.6);display:flex;flex-direction:column;gap:4px;}
